...
class EditGroupDialogFragment : Fragment() {

    companion object {
        fun newInstance() = EditGroupDialogFragment()
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_edit_group_dialog, container, false)
    }
}